 ...
 */
public abstract class BaseOnScreenControl extends Entity implements IOnSceneTouchListener {
	// ===========================================================
	// Constants
	// ===========================================================
	...
	public BaseOnScreenControl(Scene hud, final float pX, final float pY, final ITextureRegion pControlBaseTextureRegion, final ITextureRegion pControlKnobTextureRegion, final float pTimeBetweenUpdates, final VertexBufferObjectManager pVertexBufferObjectManager, final IOnScreenControlListener pOnScreenControlListener) {
//		this.setCamera(pCamera);
		...
		hud.registerTouchArea(this.mControlBase);
		hud.registerUpdateHandler(new TimerHandler(pTimeBetweenUpdates, true, new ITimerCallback() {
			@Override
		...
		hud.attachChild(this.mControlBase);
		hud.attachChild(this.mControlKnob);
